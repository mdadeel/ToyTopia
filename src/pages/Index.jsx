    ...
    <div className="min-h-screen flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 items-center">
            <div className="space-y-4 sm:space-y-6">
              <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-blue-50 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-lg border-2 border-blue-200">
                ...
                <span className="text-xs sm:text-sm font-semibold text-blue-700">The Best Toy Shop in Bangladesh!</span>
              </div>
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed max-w-[100%] sm:max-w-xl">
                Best quality toys for your kids. Delivery all over Dhaka and Chittagong. Cash on Delivery available! 🚚
              </p>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 pt-2 sm:pt-4">
                ...
                <Button 
                  variant="outline"
                  size="lg"
                  className="px-6 py-4 sm:px-8 sm:py-5 text-base sm:text-lg border-2"
                  onClick={() => alert('Please call 01700000000 for bulk orders!')}
                >
                  Call to Order
                </Button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-4 pt-3 sm:pt-6">
                <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-3 sm:p-4 text-center">
                  ...
                  <div className="text-xs sm:text-sm font-semibold text-yellow-600">Items Stock</div>
                </div>
                <div className="bg-green-50 border-2 border-green-300 rounded-xl p-3 sm:p-4 text-center">
                  <div className="text-xl sm:text-2xl md:text-3xl font-black text-green-700 mb-0.5 sm:mb-1">Original</div>
                  <div className="text-xs sm:text-sm font-semibold text-green-600">Products Only</div>
                </div>
                <div className="bg-purple-50 border-2 border-purple-300 rounded-xl p-3 sm:p-4 text-center">
                  <div className="text-xl sm:text-2xl md:text-3xl font-black text-purple-700 mb-0.5 sm:mb-1">Fast</div>
                  <div className="text-xs sm:text-sm font-semibold text-purple-600">Home Delivery</div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 lg:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 sm:p-5 md:p-6 flex items-center gap-2.5 sm:gap-3 md:gap-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm md:text-sm text-gray-600">Inside Dhaka 24 Hours</p>
              </div>
            </div>
            ...
            <div className="bg-green-50 border-2 border-green-200 rounded-xl p-4 sm:p-5 md:p-6 flex items-center gap-2.5 sm:gap-3 md:gap-4">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base md:text-lg text-gray-900">Original Product</h3>
                <p className="text-xs sm:text-sm md:text-sm text-gray-600">No Fake/Copy Items</p>
              </div>
            </div>
            ...
            <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-4 sm:p-5 md:p-6 flex items-center gap-2.5 sm:gap-3 md:gap-4">
              ...
              <div>
                <h3 className="font-bold text-sm sm:text-base md:text-lg text-gray-900">Shop Location</h3>
                <p className="text-xs sm:text-sm md:text-sm text-gray-600">Level 8, Bashundhara City</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-6 sm:py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 text-center">🔥 Popular Toys</h2>
          <Swiper
      ...
      {/* Eid special */}
      <section className="py-8 sm:py-10 bg-green-50 border-y-4 border-green-200">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h2 className="text-2xl sm:text-3xl font-bold text-green-800 mb-2">🌙 Eid Special Collection</h2>
              <p className="text-green-700 max-w-md mx-auto md:mx-0">
                Get the best gifts for your little ones this Eid! Special discounts on all electronic toys and doll sets.
              </p>
            </div>
            <div className="flex gap-4">
              <div className="bg-white p-4 rounded-xl shadow-md text-center min-w-[100px]">
                <span className="block text-2xl font-bold text-green-600">10%</span>
                <span className="text-xs text-gray-500">OFF</span>
              </div>
              <div className="bg-white p-4 rounded-xl shadow-md text-center min-w-[100px]">
                <span className="block text-2xl font-bold text-green-600">Free</span>
                <span className="text-xs text-gray-500">Wrapping</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-8 sm:py-10 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">🏆 Regional Bestsellers</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-100">
              <h3 className="text-xl font-bold text-blue-600 mb-4 flex items-center gap-2">
                <span>📍</span> Dhaka Top Picks
              </h3>
              <div className="space-y-3">
                {toys.slice(0, 3).map(toy => (
                  <div key={toy.id} className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm">
                    <img src={toy.image} alt="" className="w-12 h-12 rounded-md object-cover" />
                    <div>
                      <p className="font-semibold text-sm">{toy.name}</p>
                      <p className="text-xs text-gray-500">Trending in Gulshan</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-100">
              <h3 className="text-xl font-bold text-purple-600 mb-4 flex items-center gap-2">
                <span>📍</span> Chittagong Top Picks
              </h3>
              <div className="space-y-3">
                {toys.slice(3, 6).map(toy => (
                  <div key={toy.id} className="flex items-center gap-3 bg-white p-3 rounded-lg shadow-sm">
                    ...
                    <div>
                      <p className="font-semibold text-sm">{toy.name}</p>
                      <p className="text-xs text-gray-500">Trending in Agrabad</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="mb-8 sm:mb-10 md:mb-12 space-y-5 sm:space-y-6">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Search what you need. We have everything!
            </p>
          </div>
